...
def main() -> int:
    ...
    parser.add_argument("--ramp-values", default="160,192,224,255", help="Comma-separated throttle bytes for throttle-sweep.")
    parser.add_argument("--ramp-step-seconds", type=float, default=0.8, help="Seconds per throttle-sweep ramp value.")
    parser.add_argument("--mix-throttle", type=int, default=192, help="Base throttle byte for mix-test.")
